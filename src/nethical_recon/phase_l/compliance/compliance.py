...
class ComplianceMapper:
    ...
    def map_finding(
        self, finding: dict[str, Any], framework: ComplianceFramework
    ) -> ComplianceMapping:
        """
    ...
    def _matches_control(
        self, finding_type: str, description: str, control: ComplianceControl
    ) -> bool:
    ...
    def _identify_gaps(
        self, finding: dict[str, Any], matched_controls: list[ComplianceControl]
    ) -> list[str]:
    ...
    def generate_compliance_report(
        ...
        for mapping in mappings:
            for control in mapping.controls:
                affected_controls[control.control_id] = affected_controls.get(
