...
class IssueExporter:
    ...
    def export_finding(
        self, finding: dict[str, Any], custom_labels: list[str] | None = None
    ) -> ExportedIssue:
        """
    ...
    def _get_github_labels(
        self, severity: str, custom_labels: list[str] | None = None
    ) -> list[str]:
