...
class WorkspaceManager:
    ...
    def remove_member(self, workspace_id: UUID, user_id: UUID) -> bool:
        ...
        if user_id in workspace.member_ids:
            ...
            if workspace_id in self._members:
                self._members[workspace_id] = [
                    m for m in self._members[workspace_id] if m.user_id != user_id
                ]
    ...
    def update_member_role(
        self, workspace_id: UUID, user_id: UUID, new_role: str
    ) -> bool:
    ...
    def check_permission(
        self, workspace_id: UUID, user_id: UUID, permission: str
    ) -> bool:
        """
