...
class MySQLStore(BaseStore):
    ...
    def _row_to_dict(self, row: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'forest_location': json.loads(row['forest_location']) if isinstance(row['forest_location'], str) and row['forest_location'] else {},
            'stain': {
                ...
                'linked_tags': json.loads(row['linked_tags']) if isinstance(row['linked_tags'], str) and row['linked_tags'] else []
            },
