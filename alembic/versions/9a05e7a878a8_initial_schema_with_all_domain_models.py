...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'TIMEOUT', name='toolstatus'), nullable=False),
    ...
    sa.Column('type', sa.Enum('RAW_OUTPUT', 'JSON', 'XML', 'SCREENSHOT', 'LOG', 'REPORT', name='evidencetype'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['run_id'], ['tool_runs.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('confidence', sa.Enum('CONFIRMED', 'HIGH', 'MEDIUM', 'LOW', 'TENTATIVE', name='confidence'), nullable=False),
    ...
    sa.Column('type', sa.Enum('IP', 'DOMAIN', 'URL', 'EMAIL', 'FILE_HASH_MD5', 'FILE_HASH_SHA1', 'FILE_HASH_SHA256', 'FILE_PATH', 'MUTEX', 'REGISTRY_KEY', 'USER_AGENT', name='ioctype'), nullable=False),
