        ...
        return {
            'metadata': {
                ...
                'discovery_age_seconds': (
                    datetime.now() - discovery.timestamp
                ).total_seconds(),
...
class EnrichmentPipeline:
    ...
    def _initialize_logger(self):
        ...
        if not self.logger.handlers:
            ...
            formatter = logging.Formatter(
                "[%(asctime)s] [EnrichmentPipeline] %(levelname)s: %(message)s"
            )
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            'error_rate': (
                self.total_errors / self.total_enrichments
            ...
            'providers': {
                name: {
                    ...
                    'enrichments': self.enrichments_by_provider.get(name, 0)
                }
    ...
    def reset_statistics(self):
        ...
        self.total_enrichments = 0
        self.total_errors = 0
        self.enrichments_by_provider = {
            name: 0 for name in self.providers
        }
