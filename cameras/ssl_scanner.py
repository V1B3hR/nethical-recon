...
class SSLScanner(BaseCamera):
    ...
    def _check_vulnerabilities(self, cert_info: Dict[str, Any], 
                              hostname: str, port: int) -> List[Dict[str, Any]]:
        """
    ...
    def _generate_summary(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'warning_vulnerabilities': sum(1 for v in results['vulnerabilities'] 
