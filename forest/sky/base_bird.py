"""
🦅 Base Bird Class - Foundation for all Sky Surveillance Birds
...
class BirdType(Enum):
    ...
    EAGLE = "eagle"       # 🦅 Strategic command & overview
    FALCON = "falcon"     # 🦅 Fast response & real-time alerts
    OWL = "owl"           # 🦉 Night watch & stealth monitoring
    SPARROW = "sparrow"   # 🐦 Routine checks & heartbeat
...
class AlertLevel(Enum):
    ...
    INFO = ("info", "🟢", "chirp")           # Routine information
    WARNING = ("warning", "🟡", "hoot")      # Unusual activity
    ELEVATED = ("elevated", "🟠", "screech") # Suspicious behavior
    CRITICAL = ("critical", "🔴", "roar")    # Active threat
    BREACH = ("breach", "⚫", "caw")         # Confirmed compromise
...
class BirdAlert:
    ...
    def __str__(self) -> str:
        ...
        emoji = bird_emoji.get(self.bird_type, "🐦")
...
class BaseBird(ABC):
    ...
    - 🦅 Eagle: Strategic overview from highest altitude
    - 🦅 Falcon: Fast response with sharp vision
    - 🦉 Owl: Night-time stealth monitoring
    - 🐦 Sparrow: Routine health checks
    """
