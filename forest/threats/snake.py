...
class Snake(BaseThreat):
    ...
    def __init__(self, threat_id: str, name: str, severity: ThreatSeverity = ThreatSeverity.CRITICAL,
    ...
    def get_description(self) -> str:
        ...
        return (f"Rootkit detected: {self.name} ({self.rootkit_type}). "
    ...
    def get_behavior_pattern(self) -> str:
        ...
        behaviors = [
            f"Type: {self.rootkit_type}",
            f"Level: {self.privilege_level}"
        ]
