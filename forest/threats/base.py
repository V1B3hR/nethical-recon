...
class BaseThreat(ABC):
    ...
    def __init__(self, threat_id: str, name: str, threat_type: ThreatType,
                 severity: ThreatSeverity, metadata: Optional[Dict[str, Any]] = None):
        """
        Initialize a threat.
    ...
    def set_location(self, tree_id: str, branch_id: Optional[str] = None, 
