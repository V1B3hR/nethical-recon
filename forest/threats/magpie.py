...
class Magpie(BaseThreat):
    ...
    def __init__(self, threat_id: str, name: str, severity: ThreatSeverity = ThreatSeverity.HIGH,
    ...
    def get_description(self) -> str:
        ...
        return (f"Data stealer detected: {self.name}. "
    ...
    def get_behavior_pattern(self) -> str:
        ...
        behaviors = [
            "Seeks 'shiny' valuable data",
            "Quick grab and escape tactics"
        ]
