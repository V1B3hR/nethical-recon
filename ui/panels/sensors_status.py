...
class SensorsStatusPanel:
    ...
    def update(
        self,
        sensors_online: int = None,
        sensors_total: int = None,
    ...
    def render(self, width: int = 22) -> Panel:
        ...
        text.append(
            f"📡 {self.sensors_online}/{self.sensors_total} ONLINE\n",
            style=sensor_color
        )
        ...
        text.append(
            f"🔴 {self.cameras_online} CAMERAS ON",
            style=camera_color
        )
