...
class Dashboard:
    ...
    def __init__(self):
        ...
        self.sensors_panel = SensorsStatusPanel(
            self.status.sensors_online,
            self.status.sensors_total,
            self.status.cameras_online
        )
        self.nanobots_panel = NanobotsStatusPanel(
            self.status.nanobots_active,
            self.status.nanobots_mode
        )
        ...
        self.forest_panel = ForestStatusPanel(
            self.status.forest_trees,
            self.status.forest_branches,
            self.status.forest_leaves,
            self.status.forest_threats
        )
        self.weapon_panel = WeaponStatusPanel(
            self.status.weapon_mode,
            self.status.weapon_status,
            self.status.weapon_stealth,
            self.status.ammo_counts
        )
    ...
    def update_status(self, status: SystemStatus):
        ...
        self.sensors_panel.update(
            status.sensors_online,
            status.sensors_total,
            status.cameras_online
        )
        self.nanobots_panel.update(
            status.nanobots_active,
            status.nanobots_mode
        )
        self.forest_panel.update(
            status.forest_trees,
            status.forest_branches,
            status.forest_leaves,
            status.forest_threats
        )
        self.weapon_panel.update(
            status.weapon_mode,
            status.weapon_status,
            status.weapon_stealth,
            status.ammo_counts
        )
