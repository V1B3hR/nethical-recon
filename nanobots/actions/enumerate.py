...
class EnumeratorNanobot(BaseNanobot):
    ...
    def __init__(self, nanobot_id: str = "auto_enumerator", config: Optional[Dict[str, Any]] = None):
        ...
        self.enum_types = self.config.get('enum_types', [
            'port_scan', 'service_detection', 'os_fingerprint', 'subdomain'
        ])
    ...
    def can_handle(self, event: Dict[str, Any]) -> bool:
        ...
        return (
            'new_host_discovered' in event or
            'new_service_discovered' in event or
            'anomaly_detected' in event or
            'enumerate_target' in event
        )
