...
class RulesEngine:
    ...
    def _load_default_rules(self):
        ...
        self.add_rule(Rule(
            ...
            conditions=[
                RuleCondition("recon_activity", RuleOperator.EQUALS, True)
            ],
            priority=70,
        ...
        self.add_rule(Rule(
            ...
            conditions=[
                RuleCondition("threat_score", RuleOperator.GREATER_EQUAL, 8.0)
            ],
            priority=95,
            action_type="alert",
            confidence_modifier=0.20
        ...
        self.add_rule(Rule(
            ...
            conditions=[
                RuleCondition("iocs", RuleOperator.GREATER_THAN, 0)
            ],
            priority=80,
